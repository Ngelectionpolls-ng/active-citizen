      ...
      <div className="w-full lg:w-[60%] overflow-y-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-lg mx-auto mb-6">
          ...
          >
            ...
            >
              <path
                d="M18.1711 8.36788H17.5V8.33329H10V11.6666H14.6906C14.0377 13.6063 12.1566 15 10 15C7.23859 15 5.00003 12.7614 5.00003 9.99998C5.00003 7.23856 7.23859 5.00001 10 5.00001C11.2745 5.00001 12.4343 5.48118 13.318 6.26829L15.7054 3.88118C14.1018 2.43176 12.1345 1.66667 10 1.66667C5.39765 1.66667 1.66669 5.39764 1.66669 9.99998C1.66669 14.6023 5.39765 18.3333 10 18.3333C14.6024 18.3333 18.3334 14.6023 18.3334 9.99998C18.3334 9.44293 18.2738 8.89788 18.1711 8.36788Z"
                fill="#FFC107"
              />
              <path
                d="M2.62744 6.12121L5.36536 8.12935C6.10744 6.29519 7.90099 5.00001 9.99999 5.00001C11.2745 5.00001 12.4343 5.48118 13.318 6.26829L15.7054 3.88118C14.1018 2.43176 12.1344 1.66667 9.99999 1.66667C6.79878 1.66667 4.02235 3.47414 2.62744 6.12121Z"
                fill="#FF3D00"
              />
              <path
                d="M10 18.3333C12.0836 18.3333 14.0043 17.6014 15.5877 16.2045L12.9523 13.9844C12.0255 14.6623 11.0366 15.0012 10 15C7.85369 15 6.00276 13.6205 5.3435 11.6969L2.5719 13.8356C3.94809 16.5399 6.76063 18.3333 10 18.3333Z"
                fill="#4CAF50"
              />
              <path
                d="M18.1711 8.36788H17.5V8.33329H10V11.6666H14.6906C14.3801 12.5896 13.7837 13.3899 13.0039 13.9843C13.0039 13.9843 13.0039 13.9842 13.0039 13.9842L15.6394 16.2043C15.4819 16.3461 18.3333 14.1666 18.3333 9.99998C18.3333 9.44293 18.2738 8.89788 18.1711 8.36788Z"
                fill="#1976D2"
              />
            </svg>
