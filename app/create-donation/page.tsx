      ...
      case 3:
        return (
          <div className="space-y-6">
            ...
            <Card className="p-8 text-center cursor-pointer hover:bg-gray-50">
              <div className="flex flex-col items-center space-y-4">
                <ImageIcon className="w-12 h-12 text-gray-400" />
                <div>
                  <p className="font-medium">Upload a photo or video</p>
                  <p className="text-sm text-gray-500">Bring your story to life with media</p>
                </div>
                <Input
                  type="file"
                  className="hidden"
